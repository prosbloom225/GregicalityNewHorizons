...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("temporal_frame", "", 20, 
	...
	[<thaumadditions:vis_pod>.withTag({Aspect: "terra"}), <magicbees:frames.magic>, <thaumadditions:vis_pod>.withTag({Aspect: "terra"})], 
	[<ore:screwAluminium>, <thaumadditions:vis_pod>.withTag({Aspect: "ordo"}), <ore:screwAluminium>]]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("metabolic_frame", "", 20, 
	...
	[<thaumadditions:vis_pod>.withTag({Aspect: "ignis"}), <magicbees:frames.magic>, <thaumadditions:vis_pod>.withTag({Aspect: "ignis"})], 
	[<ore:screwAluminium>, <thaumadditions:vis_pod>.withTag({Aspect: "ignis"}), <ore:screwAluminium>]]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("gentle_frame", "", 20, 
	...
	[<thaumadditions:vis_pod>.withTag({Aspect: "aer"}), <magicbees:frames.magic>, <thaumadditions:vis_pod>.withTag({Aspect: "aer"})], 
	[<ore:screwAluminium>, <thaumadditions:vis_pod>.withTag({Aspect: "aer"}), <ore:screwAluminium>]]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("necrotic_frame", "", 20, 
	...
	[<thaumadditions:vis_pod>.withTag({Aspect: "ordo"}), <magicbees:frames.magic>, <thaumadditions:vis_pod>.withTag({Aspect: "ordo"})], 
	[<ore:screwAluminium>, <thaumadditions:vis_pod>.withTag({Aspect: "ordo"}), <ore:screwAluminium>]]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("oblivion_frame", "", 100, 
	...
	[<thaumadditions:vis_pod>.withTag({Aspect: "perditio"}), <magicbees:frames.magic>, <thaumadditions:vis_pod>.withTag({Aspect: "perditio"})], 
	[<ore:screwStainlessSteel>, <thaumadditions:vis_pod>.withTag({Aspect: "perditio"}), <ore:screwStainlessSteel>]]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("resilient_frame", "", 100, 
	...
	[[<ore:screwAluminium>, <magicbees:resource:10>, <ore:screwAluminium>], 
	[<thaumadditions:vis_pod>.withTag({Aspect: "ordo"}), <magicbees:frames.magic>, <thaumadditions:vis_pod>.withTag({Aspect: "ordo"})], 
	[<ore:screwAluminium>, <thaumadditions:vis_pod>.withTag({Aspect: "ordo"}), <ore:screwStainlessSteelscrewAluminium>]]);
