...
val robotArmMv = <gregtech:meta_item_1:32651>;
val pistonIv = <gregtech:meta_item_1:32644>;
...
mods.thaumcraft.Infusion.registerRecipe("demon_crucible", "", <bloodmagic:demon_crucible>, 12, 
	...
	[<magicbees:wax:1>, <bloodmagic:slate:2>, <ore:craftingFurnace>, 
	<magicbees:wax:1>, <bloodmagic:slate:2>, <ore:craftingFurnace>, 
	<magicbees:wax:1>, <bloodmagic:slate:2>, <ore:craftingFurnace>]);
...
mods.thaumcraft.Infusion.registerRecipe("demon_pylon", "", <bloodmagic:demon_pylon>, 12, 
	...
	<ore:blockTitanium>, 
	[<bloodmagic:slate:3>, <bloodmagic:item_demon_crystal>, <bloodmagic:slate:3>, <bloodmagic:item_demon_crystal:3>, 
...
mods.thaumcraft.Infusion.registerRecipe("demon_crystallizer", "", <bloodmagic:demon_crystallizer>, 8, 
	...
	<ore:blockThaumium>, 
	[<bloodmagic:slate:2>, <ore:plateStainlessSteel>, <bloodmagic:slate:2>, <ore:plateStainlessSteel>, 
...
compressor.recipeBuilder()
	.inputs([<bloodmagic:demon_crystal> *4])
...
compressor.recipeBuilder()
	.inputs([<bloodmagic:demon_crystal:1> *4])
...
compressor.recipeBuilder()
	.inputs([<bloodmagic:demon_crystal:2> *4])
	.outputs(<bloodmagic:demon_crystal:2>)
	.duration(2000).EUt(384).buildAndRegister();
	
// Vengeful Will Cluster
recipes.remove(<bloodmagic:demon_crystal:3>);
compressor.recipeBuilder()
	.inputs([<bloodmagic:demon_crystal:3> *4])
	.outputs(<bloodmagic:demon_crystal:3>)
	.duration(2000).EUt(384).buildAndRegister();
	
// Steadfast Will Cluster
recipes.remove(<bloodmagic:demon_crystal:41>);
compressor.recipeBuilder()
	.inputs([<bloodmagic:demon_crystal:4> *4])
	.outputs(<bloodmagic:demon_crystal:4>)
	.duration(2000).EUt(384).buildAndRegister();
...
mods.bloodmagic.TartaricForge.addRecipe(<bloodmagic:master_routing_node>,
	[<integratedtunnels:part_interface_item_item>, robotArmMv, <bloodmagic:slate:2>], 
	400,200);
...
mods.bloodmagic.TartaricForge.addRecipe(<bloodmagic:input_routing_node>,
	[<integratedtunnels:part_importer_item_item>, <bloodmagic:slate:2>], 
	400,25);
...
mods.bloodmagic.TartaricForge.addRecipe(<bloodmagic:output_routing_node>,
	[<integratedtunnels:part_exporter_item_item>, <bloodmagic:slate:2>], 
	400,25);
...
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:activation_crystal>, <gregtech:meta_item_2:32212>, 2, 20000, 2,2);

// Weak Activation Crystal
recipes.remove(<bloodmagic:activation_crystal:1>);
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:activation_crystal:1>, <gregtech:meta_item_1:32725>, 2, 120000, 2,2);
...
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:inscription_tool:1>, <thaumadditions:seal_symbol>.withTag({Aspect: "aqua"}), 2, 5000, 20,20);

// Elemental Incription Tool - Fire
mods.bloodmagic.BloodAltar.removeRecipe(<minecraft:magma_cream>);
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:inscription_tool:2>, <thaumadditions:seal_symbol>.withTag({Aspect: "ignis"}), 2, 5000, 20,20);

// Elemental Incription Tool - Earth
mods.bloodmagic.BloodAltar.removeRecipe(<minecraft:obsidian>);
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:inscription_tool:3>, <thaumadditions:seal_symbol>.withTag({Aspect: "terra"}), 2, 5000, 20,20);

// Elemental Incription Tool - Air
mods.bloodmagic.BloodAltar.removeRecipe(<minecraft:ghast_tear>);
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:inscription_tool:4>, <thaumadditions:seal_symbol>.withTag({Aspect: "aer"}), 2, 5000, 20,20);

// Elemental Incription Tool - Dusk
mods.bloodmagic.BloodAltar.removeRecipe(<minecraft:coal_block>);
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:inscription_tool:5>, <thaumadditions:seal_symbol>.withTag({Aspect: "perditio"}), 3, 100000, 20,20);
...
mods.thaumcraft.Infusion.registerRecipe("ritual_diviner", "", <bloodmagic:ritual_diviner>, 4, 
	...
	[<gregtech:meta_item_1:2294>, <bloodmagic:inscription_tool:1>, <ore:gemFlawlessDiamond>, <bloodmagic:inscription_tool:2>, <ore:gemFlawlessEmerald>, 
...
mods.thaumcraft.Infusion.registerRecipe("lava_crystal", "", <bloodmagic:lava_crystal>, 6, 
	[<aspect:ignis> *24, <aspect:terra> *18, <aspect:praecantatio> *18, <aspect:infernum> *6, <aspect:aer> *6], 
	<ore:plateRoseGold>, 
	[<tconstruct:firewood>, <thaumicaugmentation:fortified_glass>, <ore:gemFlawlessDiamond>, <thaumicaugmentation:fortified_glass>]);
...
mods.thaumcraft.Infusion.registerRecipe("sigil_green_grove", "", <bloodmagic:sigil_green_grove>, 8, 
	...
	<bloodmagic:slate:1>, 
	[<thaumicbases:endersapling>, <bloodmagic:component:5>, <thaumicbases:goldensapling>, <bloodmagic:component:5>, <thaumicbases:nethersapling>, 
...
mods.thaumcraft.Infusion.registerRecipe("sigil_blood_light", "", <bloodmagic:sigil_blood_light>, 6, 
	...
	<bloodmagic:slate:2>, 
	[<ore:nitor>, <bloodmagic:component:11>, <bloodarsenal:slate:2>, <bloodmagic:component:11>, <ore:nitor>, 
	<bloodmagic:component:11>, <bloodarsenal:slate:2>, <bloodmagic:component:11>]);
...
mods.thaumcraft.Infusion.registerRecipe("sigil_whirlwind", "", <bloodmagic:sigil_whirlwind>, 14, 
	...
	[<thaumadditions:levitation_device>, <bloodmagic:component:2>, <minecraft:potion>.withTag({Potion: "minecraft:strong_leaping"}), <bloodmagic:slate:3>, 
	<minecraft:ghast_tear>, <bloodmagic:component:2>, <thaumadditions:levitation_device>, <bloodmagic:component:2>, <minecraft:potion>.withTag({Potion: "minecraft:strong_leaping"}), 
...
mods.thaumcraft.Infusion.registerRecipe("sigil_compression", "", <bloodmagic:sigil_compression>, 14, 
	...
	<bloodmagic:slate:3>, 
	[<bloodmagic:slate:3>, pistonIv, <gregtech:machine:825>, motorIv, <bloodmagic:slate:3>, motorIv, <gregtech:machine:825>, pistonIv]);
...
mods.thaumcraft.Infusion.registerRecipe("sigil_ender_severance", "", <bloodmagic:sigil_ender_severance>, 14, 
	...
	<bloodmagic:slate:4>, 
	[<thaumcraft:causality_collapser>, <bloodmagic:slate:3>, <gregtech:meta_item_1:32724>, <tconstruct:slime_congealed:2>, <bloodmagic:component:16>, 
	<gregtech:meta_item_1:32724>, <bloodmagic:component:16>, <tconstruct:slime_congealed:2>, <gregtech:meta_item_1:32724>, <bloodmagic:slate:3>]);
	
// Sigil of Holding
mods.bloodmagic.AlchemyArray.removeRecipe(<bloodmagic:component:27>, <bloodmagic:slate:2>);
mods.bloodmagic.AlchemyTable.removeRecipe([<bloodmagic:sigil_holding>, <minecraft:dye>]);
...
// Sight Reagent
mods.bloodmagic.TartaricForge.removeRecipe([<bloodmagic:sigil_divination>, <minecraft:glass>, <minecraft:glowstone_dust>, <minecraft:glass>]);
mods.bloodmagic.AlchemyTable.addRecipe(<bloodmagic:component:7>, 
	[<biomesoplenty:hard_ice>, <ore:dustIce>, <bloodmagic:component:29>, 
	<ore:dustIce>, <ore:dustIce>],
	1000,200,2);
...
mods.bloodmagic.AlchemyTable.addRecipe(<bloodmagic:component:8>,
	[<bloodmagic:ritual_controller>, <magicbees:drop>, <gregtech:meta_item_1:32682>, <ore:ingotMithrillium>], 
	1000,200,2);
...
mods.bloodmagic.AlchemyTable.addRecipe(<bloodmagic:component:11>,
	[<bloodmagic:component:28>, <ore:dustPlutoniumRadioactive239>, <ore:dustCertusQuartz>, 
	<ore:dustCertusQuartz>, <ore:dustPlutoniumRadioactive239>], 
	4000,200,3);
...
mods.bloodmagic.AlchemyTable.addRecipe(<bloodmagic:component:12>,
	[<bloodmagic:component:28>, <gregtech:meta_item_2:32572>, <ore:dustUltimet>, 
	<ore:dustUltimet>, <gregtech:meta_item_2:32572>], 
	2000,200,2);
...
mods.bloodmagic.AlchemyTable.removeRecipe([<minecraft:gunpowder>, <minecraft:nether_wart>, <minecraft:redstone>]);
mods.bloodmagic.AlchemyTable.addRecipe(<bloodmagic:component:29>,
	[<thaumcraft:phial>, <ore:dustGlowstone>, <minecraft:gunpowder>, <minecraft:redstone>, <genetics:misc:4>], 
	500,200,1);
...
recipes.addShaped(<bloodmagic:teleposition_focus:2>, 
	[[null, <bloodmagic:blood_shard>, null],
	[<bloodmagic:blood_shard>, <bloodmagic:teleposition_focus:1>, <bloodmagic:blood_shard>],
	[<bloodmagic:blood_orb>.withTag({orb: "bloodmagic:master"}), <bloodmagic:blood_shard>, <bloodmagic:blood_orb>.withTag({orb: "bloodmagic:master"})]]);

// Demonic Teleposition Focus
recipes.remove(<bloodmagic:teleposition_focus:3>);
recipes.addShaped(<bloodmagic:teleposition_focus:3>, 
	[[null, <bloodmagic:blood_shard:1>, null],
	[<bloodmagic:blood_shard:1>, <bloodmagic:teleposition_focus:1>, <bloodmagic:blood_shard:1>],
	[<bloodmagic:blood_orb>.withTag({orb: "bloodmagic:archmage"}), <bloodmagic:blood_shard:1>, <bloodmagic:blood_orb>.withTag({orb: "bloodmagic:archmage"})]]);

// Weak Blood Shard
recipes.addShapeless(<bloodmagic:blood_shard>, 
	[<bloodmagic:blood_orb>.withTag({orb: "bloodmagic:magician"}), <bloodmagic:blood_shard>, <bloodmagic:slate:2>]);
recipes.addShapeless(<bloodmagic:blood_shard>, 
	[<bloodmagic:blood_orb>.withTag({orb: "bloodmagic:master"}), <bloodmagic:blood_shard>, <bloodmagic:slate:2>]);
recipes.addShapeless(<bloodmagic:blood_shard>, 
	[<bloodmagic:blood_orb>.withTag({orb: "bloodmagic:archmage"}), <bloodmagic:blood_shard>, <bloodmagic:slate:2>]);

// Blood Shard
recipes.addShapeless(<bloodmagic:blood_shard:1>, 
	[<bloodmagic:blood_orb>.withTag({orb: "bloodmagic:master"}), <bloodmagic:blood_shard:1>, <bloodmagic:slate:3>]);
recipes.addShapeless(<bloodmagic:blood_shard:1>, 
	[<bloodmagic:blood_orb>.withTag({orb: "bloodmagic:archmage"}), <bloodmagic:blood_shard:1>, <bloodmagic:slate:3>]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("petty_tartaric_gem", "", 100, 
	...
	[<bloodmagic:slate>, <gregtech:meta_item_1:32528>, <bloodmagic:slate>], 
	[<ore:screwAluminium>, <bloodmagic:slate>, <ore:screwAluminium>]]);
...
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:node_router>, <integrateddynamics:wrench>, 0, 5000, 20, 20);

// Precise Item Filter
recipes.remove(<bloodmagic:base_item_filter>);
assembler.recipeBuilder()
	.inputs([<bloodmagic:component:10>, <gregtech:meta_item_1:32729>])
...
assembler.recipeBuilder()
	.inputs([<bloodmagic:component:10>, <gregtech:meta_item_1:32102>])
...
recipes.remove(<bloodmagic:base_item_filter:1>);
assembler.recipeBuilder()
	.inputs([<bloodmagic:component:10>, <ore:circuitGood>])
	.outputs(<bloodmagic:base_item_filter:1>)
	.duration(2000).EUt(30).buildAndRegister();
