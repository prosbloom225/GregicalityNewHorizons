...
val circuitBoardElite = <gtadditions:ga_meta_item:32034>;
...
assembler.recipeBuilder()
	.inputs([<forestry:alveary.plain>, <forestry:thermionic_tubes:1> *4, <ore:wireGtDoubleTin> *2, motorHv, <ore:circuitAdvanced>])
...
assembler.recipeBuilder()
	.inputs([<forestry:alveary.plain>, <forestry:thermionic_tubes> *4, <ore:circuitAdvanced>, <ore:cableGtDoubleAluminium> *3, machineCasingHv])
...
recipes.addShaped(<genetics:machine>, 
	[[<genetics:misc:3>, <gregtech:machine:804>, <genetics:misc:3>], 
...
recipes.addShaped(<genetics:machine:1>, 
	[[<genetics:misc:2>, <gregtech:machine:804>, <genetics:misc:2>], 
	[<genetics:misc:8>, machineCasingMv, <genetics:misc:8>], 
	[<ore:gearSmallStainlessSteel>, motorMv, <ore:gearSmallStainlessSteel>]]);
...
recipes.addShaped(<genetics:machine:2>, 
	[[<genetics:misc:7>, <gregtech:machine:804>, <genetics:misc:7>], 
	[<genetics:misc:8>, machineCasingMv, <genetics:misc:8>], 
	[<ore:gearSmallStainlessSteel>, motorMv, <ore:gearSmallStainlessSteel>]]);
...
recipes.addShaped(<genetics:machine:3>, 
	[[<ore:plateEmerald>, <gregtech:machine:804>, <ore:plateEmerald>], 
	[<genetics:misc:8>, machineCasingMv, <genetics:misc:8>], 
	[<ore:gearSmallStainlessSteel>, motorMv, <ore:gearSmallStainlessSteel>]]);
...
recipes.addShaped(<genetics:lab_machine:1>, 
	[[<genetics:misc:1>, <gregtech:machine:804>, <genetics:misc:1>], 
	[<genetics:misc:8>, machineCasingMv, <genetics:misc:8>], 
	[<ore:gearSmallStainlessSteel>, motorMv, <ore:gearSmallStainlessSteel>]]);
...
recipes.addShaped(<genetics:lab_machine:2>, 
	[[<gregtech:machine:814>, <ore:craftingFurnace>, <gregtech:machine:814>], 
	[<genetics:misc:8>, machineCasingMv, <genetics:misc:8>], 
	[<ore:gearSmallStainlessSteel>, motorMv, <ore:gearSmallStainlessSteel>]]);
...
recipes.addShaped(<genetics:lab_machine:3>, 
	[[<gregtech:machine:814>, <gregtech:machine:804>, <gregtech:machine:814>], 
	[<genetics:misc:8>, machineCasingMv, <genetics:misc:8>], 
	[<ore:gearSmallStainlessSteel>, motorMv, <ore:gearSmallStainlessSteel>]]);
